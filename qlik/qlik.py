...
def help():
    ...
    print("")
    print("🟢 qlik get_measures         <app_name>  [<app_id>]: Get all master measures from app and save to measures.json, optionally provide the app_id if multiple apps share the same name")
    print("🟢 qlik set_measures         <app_name>  [<app_id>]: Set all master measures in app from measures.json, optionally provide the app_id if multiple apps share the same name")
    print("🟢 qlik get_dimensions       <app_name>  [<app_id>]: Get all master dimensions from app and save to dimensions.json, optionally provide the app_id if multiple apps share the same name")
    print("🟢 qlik set_dimensions       <app_name>  [<app_id>]: Set all master dimensions in app from dimensions.json, optionally provide the app_id if multiple apps share the same name")
    print("")
